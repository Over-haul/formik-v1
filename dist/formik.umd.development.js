(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    /*#__PURE__*/
    React.createContext({}), _a.Provider),
    ...
    function (_super) {
        ...
        _this.runValidations = function (values) {
          ...
          if (_this.validateSync) {
            try {
              ...
              var schemaErrors = _this.props.validationSchema ? _this.runValidationSchema(values) : {};
              var handlerErrors = _this.props.validate ? _this.runValidateHandler(values) : {};
              var errors_1 = deepmerge_1.all([fieldErrors, schemaErrors, handlerErrors], {
                arrayMerge: arrayMerge
              });

              if (_this.didMount) {
                _this.setState(function (prevState) {
                  if (!reactFastCompare(prevState.errors, errors_1)) {
                    return {
                      errors: errors_1
                    };
                  }
      ...
      Formik.prototype.runFieldLevelValidations = function (values) {
        ...
        if (this.validateSync) {
          ...
          var fieldValidations = fieldKeysWithValidation_2.length > 0 ? fieldKeysWithValidation_2.map(function (f) {
            return _this.runSingleFieldLevelValidation(f, getIn(values, f));
    ...
    function (_super) {
      ...
      function FieldInner(props) {
        ...
        warning(!(component && children && isFunction$1(children)), 'You should not use <Field component> and <Field children> as a function in the same <Field> component; <Field component> will be ignored.');
    ...
    function (_super) {
      ...
      function FastFieldInner(props) {
        ...
        warning(!(component && children && isFunction$1(children)), 'You should not use <FastField component> and <FastField children> as a function in the same <FastField> component; <FastField component> will be ignored.');
